...
const users = [
  ...
  },
  {
    ...
    content:
      "너는 내가 한국에서 본 사람 중에 가장 미친 사람이야! 함께한 모든 순간들 정말 고마워. 너랑 있으면 정말 많이 웃었어. 아무것도 안 하거나, 식당에 가거나, 게으르게 시간 보낸 모든 순간들이 내 기억 속에 오래 남을 거야. 이 여행은 너 없었으면 정말 달랐을 거야. 이런 잊지 못할 순간들을 함께해 줘서 고마워. 그리고 내가 한국에서 만난 사람들 중 너는 내 가장 친한 친구였어! 너는 정말 멋진 사람이고 절대 변하지 않았으면 좋겠어. 우리가 다시 만날 수 있으면 좋겠고 계속 연락하며 지냈으면 좋겠어. 앞으로도 행복하고, 행운이 가득하길 바랄게. 다시 만날 날을 기다리면서, 고마워!",
    image:
