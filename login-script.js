...
const users = [
  ...
  {
    id: "소희",
    password: "미쳤어", // 미쳤어 tu es fou ?
    content:
      "너는 내가 본 한국 사람 중에서, 퐁이랑 함께 가장 유쾌하고 엉뚱한 친구야! 함께한 모든 순간들에 감사해. 너희와 같이 있으면 정말 많이 웃게 돼. 우리 같이 멍 때리거나, 식당에 가거나, 백수처럼 아무것도 안 하던 모든 순간들이 절대 잊지 못할 기억이야. 이 여행은 너 없이는 달랐을 거야. 잊지 못할 순간들을 함께해 줘서 고마워.그리고 너는 내가 한국에서 만난 사람들 중 최고의 여성 친구야! 너는 정말 멋진 사람이고 절대 바뀌지 않았으면 좋겠어. 꼭 다시 만나고 싶고 계속 연락하며 지내고 싶어. 앞으로도 행복하길 바라고, 많은 행운이 함께하길 바랄게. 다시 만날 날을 기대하면서, 고마워!",
    image:
