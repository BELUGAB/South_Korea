...
const users = [
  ...
  },
  {
    ...
    password: "뒤질래",
    content:
      "지난 몇 주 동안 나를 위해 해준 모든 것들에 대해 정말 고마워. 내가 처음 너를 만났던 순간이 기억나. CU에서 처음 봤는데, 너는 내게 Pepero Day를 기념해서 선물을 준 첫 번째 사람이었어. 한국의 이 전통에 참여할 수 있어서 정말 행복했어. 처음에는 조금 수줍어했지만, 시간이 지날수록 너의 진짜 모습을 알게 되었어. 너는 정말 멋진 사람이고, 친절하면서도 원칙과 가치를 가지고 있는 사람이라는 걸 느꼈어. 함께 보낸 모든 순간들이 영원히 내 기억 속에 남을 거야. 너는 내 한국 경험의 중요한 한 조각이었어, 그리고 그것에 대해 정말 감사하게 생각해. 앞으로 네가 하는 모든 일에 행운과 성공이 가득하길 바랄게. 정말 고마웠고, 파리에서 곧 다시 만나자!",
    image:
      "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExYjdzamcxcTU0bHB3cDU3MzNocnRzenFta2hxZ3o4OHZnNnk2ZnhmNiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/KB8C86UMgLDThpt4WT/giphy.gif",
  },
